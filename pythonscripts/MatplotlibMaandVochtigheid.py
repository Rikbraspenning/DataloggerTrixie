...
# in deze query selecteren we de 2976 laatste metingen
query = """
SELECT dateandtime,humidity FROM temperaturedata
ORDER BY dateandtime DESC LIMIT 2976;
"""
...
plt.title("Relatieve vochtigheid "+" Raspi15 " + vandaag)
...
# plt.show()
fig.savefig(os.path.expanduser('~/pythonscripts/grafieken/Raspi15MaandVochtigheid.png'), dpi=100)
